...
import { Activity, Settings, ShieldAlert, LogOut, X, PanelLeftClose, PanelLeftOpen, BrainCircuit } from 'lucide-react';
        ...
        <div className={clsx('space-y-3 border-t border-[#222] bg-[#0a0a0a]/50 p-3', collapsed && 'items-center')}>
          {!collapsed && (
            <div className="rounded-xl border border-[#333] bg-[#1a1a1a] p-4">
              ...
              <div className="text-sm font-bold text-white">Football Analysis</div>
              <div className="mt-1 text-xs text-gray-500">AI-powered pre-match analysis</div>
            </div>
          )}
