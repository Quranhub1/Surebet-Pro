...
import { Search, Loader2, Radar, Radio, Target, BrainCircuit } from 'lucide-react';
...
export function Dashboard() {
  ...
  const formatAiProvider = (provider: MatchPrediction['aiProvider']) => provider === 'gemini' ? 'Gemini' : provider === 'groq' ? 'Groq' : 'AI';
