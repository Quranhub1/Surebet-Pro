        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div className="flex-1 w-full">
            <h1 className="text-3xl font-extrabold text-white tracking-tight mb-1 flex items-center gap-3">
              Live Scanner
              <span className="text-xs font-bold bg-[#39FF14]/10 text-[#39FF14] px-3 py-1 rounded-full border border-[#39FF14]/20 flex items-center gap-2">
          ...
          <div className="bg-[#161618] border border-[#2c2e33] rounded-2xl p-16 text-center shadow-lg">
            <div className="flex flex-col items-center justify-center text-[#8b8d93]">
              ...
              <p className="text-sm max-w-md text-center leading-relaxed">
                The scanner is running automatically. New matches are generated every 12 hours and live matches are refreshed continuously.
              </p>
            </div>
          </div>
        ) : (
